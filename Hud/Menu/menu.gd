...
func _ready():
	...
	save_now_button.set_icon(res.get_resource("Save"))
	load_now_button.set_icon(res.get_resource("Save"))
	rename_button.set_icon(res.get_resource("Rename"))
	color_button.set_icon(res.get_resource("Color"))
	duplicate_button.set_icon(res.get_resource("Duplicate"))
	delete_button.set_icon(res.get_resource("Delete"))
	hard_reset_button.set_icon(res.get_resource("Hard Reset"))
	export_button.set_icon(res.get_resource("Clipboard"))
	new_game_button.set_icon(res.get_resource("New Game"))
